                    ...
                    <div class="input-group justify-content-center mb-2">
                      <div class="input-group-prepend">
                        <span class="input-group-text" id="incrementar_modal_{{$acce}}" data="{{$acce}}">                  
                          <i class="fas fa-plus" style="color: #4169E1;" data-container="body" data-toggle="popover" data-placement="left" data-content="Haz click e incrementa tu pedido" id="plus_modal_{{$acce}}"></i>                
                        </span>
                      </div>
                      ...
                      <input type="hidden" value="{{$p->inventario}}"  id="inventario_modal_{{$acce}}">
