...
<div class="container-fluid" style="background-color: #968F8F">
         ...
         <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12">
              ...
              <div class="col-lg-2 col-md-2 col-sm-12">
                ...
                <div class="input-group mb-3">
                    <input min="0" step=".01" type="number" name="monto" class="form-control @error('monto') is-invalid @enderror" id="monto" placeholder="Monto de la Tasa" value="{{$tasas->monto}}">
                 @error('monto')
                    <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                    </span>
        ...
        <div class="row"><hr style="padding: 40px;"></div>
</div>
<div class="row">
